var scrollme = function(e) {
    ...
    return t.body_height = 0, t.viewport_height = 0, t.viewport_top = 0, t.viewport_bottom = 0, t.viewport_top_previous = -1, t.elements = [], t.elements_in_view = [], t.property_defaults = {
        ...
        }), setInterval(t.update, t.update_interval), !0)
        ...
        for (var e = t.elements_in_view.length, a = 0; a < e; a++)
            for (var n = t.elements_in_view[a], i = n.effects.length, o = 0; o < i; o++) {
                var r = n.effects[o];
                switch (r.when) {
                    case "view":
                    case "span":
                ...
                r.crop && (s < 0 && (s = 0), l > t.body_height - t.viewport_height && (l = t.body_height - t.viewport_height));
                ...
                "scale" in r.properties && (z = x, b = x, k = x), r.element.css({
                    opacity: d,
                    transform: "translate3d( " + h + "px , " + v + "px , " + f + "px ) rotateX( " + w + "deg ) rotateY( " + g + "deg ) rotateZ( " + y + "deg ) scale3d( " + z + " , " + b + " , " + k + " )"
                })
            }
        ...
        t.elements_in_view = [];
        for (var e = t.elements.length, a = 0; a < e; a++) t.elements[a].top < t.viewport_bottom && t.elements[a].bottom > t.viewport_top && t.elements_in_view.push(t.elements[a])
